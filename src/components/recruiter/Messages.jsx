...
const RecruiterMessages = () => {
  const conversations = [
    { id: 1, name: 'Marcus Johnson', role: 'Candidate', lastMessage: 'Thank you for considering my application', time: '1h ago', unread: 1 },
    { id: 2, name: 'David Williams', role: 'Candidate', lastMessage: 'When can we schedule the interview?', time: '3h ago', unread: 0 },
    { id: 3, name: 'James Mitchell', role: 'Candidate', lastMessage: 'I have updated my profile', time: '1d ago', unread: 0 },
  ];
    ...
    <Layout userType="recruiter" userName="Sarah Chen" userEmail="sarah.techcoop.com">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Communicate with candidates and your team</p>
        </div>
