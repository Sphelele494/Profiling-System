// src/components/user/Learning.jsx
// Enhanced with South African accredited courses and training providers

import React, { useState } from 'react';
import Layout from '../shared/Layout';
import { 
  BookOpen, CheckCircle2, Play, Clock, ExternalLink, 
  GraduationCap, Award, Building2, Globe, Filter, Search,
...
const Learning = () => {
  ...
  const user = JSON.parse(localStorage.getItem('relink_user') || '{}');

  // User's ongoing courses
  // const myCourses = [
  //   { 
  //     id: 1, 
  ...
  return (
    <Layout userType="user" userName={user.name || "Marcus Johnson"} userEmail={user.email || "marcus@email.com"}>
      <div className="space-y-6">
        {/* Header */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Learning & Development</h1>
            <p className="text-gray-600">Continue your education and skill development with accredited South African courses</p>
          </div>
        </div>
